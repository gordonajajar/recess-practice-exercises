...
long find_largest(long n){
    /**
      An integer can be transformed into another by rearranging its digits. 
      Given a number n, we want to find the largest number after rearranging the digits in n.
      ...
      Some things to consider:
        ...
        2. Is there a difference in building the largest number when given positive versus a negative n?
     **/
